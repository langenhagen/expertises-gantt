...
d3.gantt = function() {
    ...
    var parentSelector              // selector of parent container
    var selector;                   // diagram content selector
    ...
    var textWidth = 220;            // max length of the text on the y axis
    var xAxisHeight = 50;           // height reserved for the text of the x axis
    ...
    */
    var hoverRectTransform = function(d) { return "translate( " + - textWidth + ", " + yScale(d.taskName) + ")"; };
    ...
    */
    function gantt(tasks) {
        ...
        var entryHeight = 20; // height of one entry row
